...
export const fetchCity = (details) => {
    return function (dispatch) {
        axios.all([
            axios.get('https://api.openweathermap.org/data/2.5/weather?q=' + details.city + '&units=metric&APPID=a44e37bfe521db4bf31b0b57918362bf'),
            axios.get('https://api.openweathermap.org/data/2.5/forecast?q=' + details.city + '&APPID=a44e37bfe521db4bf31b0b57918362bf')
        ])
