...
export const fetchCity = (details) => {
    ...
    return function (dispatch) {
        axios.all([
            axios.get('http://api.openweathermap.org/data/2.5/weather?q=chennai&units=metric&APPID=a44e37bfe521db4bf31b0b57918362bf'),
            axios.get('http://api.openweathermap.org/data/2.5/forecast?q=chennai&APPID=a44e37bfe521db4bf31b0b57918362bf')
        ])
